...
def GANAE(input_shape, order, batch_size=128, num_layers=4, train_disc=True):
    ...
    if train_disc:
        ...
        gan.compile(loss=['binary_crossentropy', 'mse'], loss_weights=[1.0, 2.0], optimizer=optimizer)
        ...
        gan.compile(loss=['binary_crossentropy', 'mse', l2_loss], loss_weights=[1.0, 2.0, 1.0], optimizer=optimizer)
