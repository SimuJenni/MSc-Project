...
def EBGAN(input_shape, batch_size=128, load_weights=False, num_layers_g=4, num_layers_d=4, noise=None, train_disc=True,
          r_weight=50.0, w2=1.0, num_res=0):
    # Build Generator
    input_gen = Input(batch_shape=(batch_size,) + input_shape)
    ...
    if train_disc:
        ...
        gan.compile(loss=['mse'] * 3, loss_weights=[r_weight, -w2, -1.0], optimizer=optimizer)
        ...
        gan.compile(loss=['mse'] * 2, loss_weights=[w2, 1.0], optimizer=optimizer)
