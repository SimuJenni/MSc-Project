...
# Training
history = generator.fit_generator(datagen.flow_from_directory(data.train_dir, batch_size=batch_size, xy_fun=X2X_X2Y),
                                  samples_per_epoch=samples_per_epoch,
                                  nb_epoch=num_epochs,
                                  validation_data=datagen.flow_from_directory(data.val_dir, batch_size=batch_size, xy_fun=X2X_X2Y),
