...
from constants import IMAGENET_TF_256_DATADIR, IMAGENET_TF_256_TOON_DATADIR
...
class ImageNet(Dataset):
    ...
    def get_toon_train(self):
        return self.get_split('train', data_dir=IMAGENET_TF_256_TOON_DATADIR)

    def get_testset(self):
        return self.get_split('validation')

    def get_toon_test(self):
        return self.get_split('validation', data_dir=IMAGENET_TF_256_TOON_DATADIR)
