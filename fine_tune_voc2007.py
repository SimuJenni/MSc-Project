...
trainer = ToonNetTrainer(model=model, dataset=data, pre_processor=preprocessor, num_epochs=250, tag='NEW_correct_17',
...
chpt_path = os.path.join(LOG_DIR, 'imagenet_ToonNet_default_NEW_correct3/model.ckpt-1499809')
