...
trainer = ToonNetTrainer(model=model, dataset=data, pre_processor=preprocessor, num_epochs=250, tag='NEW_correct_4',
...
chpt_path = os.path.join(LOG_DIR, 'imagenet_ToonNet_default_vanilla_correct/model.ckpt-721575')
chpt_path = os.path.join(LOG_DIR, 'imagenet_ToonNet_default_NEW_correct/model.ckpt-747962')
