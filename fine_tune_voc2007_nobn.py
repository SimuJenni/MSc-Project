...
data = ImageNet()
preprocessor = VOCPreprocessor(target_shape=[227, 227, 3], augment_color=False, area_range=(0.25, 1.0))
...
chpt_path = '/Data/Logs/ToonNet/imagenet_ToonNet_default_continuation/model.ckpt-1162420'
