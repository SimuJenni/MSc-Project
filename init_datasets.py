...
from datasets import convert_voc2007_toon, convert_imagenet_toon_easy
...
convert_imagenet_toon_easy.run(IMAGENET_TRAIN_DIR, IMAGENET_VAL_DIR, IMAGENET_SMALL_TF_DATADIR)
