...
class ToonNet:
    ...
    def net(self, imgs, reuse=None, training=True):
        ...
        disc_real, __ = self.discriminator.discriminate(dec_im, reuse=reuse, training=training)
        disc_fake,  __ = self.discriminator.discriminate(dec_pdrop, reuse=True, training=training)

        return dec_im, dec_pdrop, disc_real, disc_fake
