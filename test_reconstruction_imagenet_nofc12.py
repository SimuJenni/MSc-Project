...
data = ImageNet()
preprocessor = Preprocessor(target_shape=[227, 227, 3], augment_color=True, hsv_color=False)
tester = ToonNetTester(model=model, dataset=data, pre_processor=preprocessor, tag='nofc11')
