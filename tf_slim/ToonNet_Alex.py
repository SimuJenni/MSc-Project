...
def discriminator(net, reuse=None, num_out=2, training=True, train_fc=True, weight_decay=0.00001, bn_decay=0.95):
    ...
    with tf.variable_scope('discriminator', reuse=reuse):
        with slim.arg_scope(toon_net_argscope(activation=lrelu, padding='SAME', training=training,
            ...
            net = slim.fully_connected(net, 2048, scope='fc2', trainable=train_fc)
