...
with sess.as_default():
    with g.as_default():
        ...
        with tf.device('/cpu:0'):
            ...
            provider = slim.dataset_data_provider.DatasetDataProvider(train_set, num_readers=10,
                                                                      common_queue_capacity=10 * model.batch_size,
            ...
            imgs_train, labels_train = tf.train.batch([img_train, label_train], batch_size=model.batch_size,
                                                      num_threads=10, capacity=5 * model.batch_size)
