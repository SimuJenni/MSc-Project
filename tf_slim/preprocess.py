...
def preprocess_voc(image, output_height, output_width, augment_color=True, aspect_ratio_range=[0.75, 1.33],
                   area_range=[0.5, 1.0]):
    # Select random crops
...
def batch_inputs(dataset, batch_size, train, num_preprocess_threads=4,
                 num_readers=4):
