...
if finetuned:
    MODEL_PATH = os.path.join(LOG_DIR, '{}_{}_finetune_{}_no_KL/'.format(data.NAME, model.name, net_type))
    LOG_PATH = os.path.join(LOG_DIR, '{}_{}_finetune_{}_eval_no_KL/'.format(data.NAME, model.name, net_type))
else:
