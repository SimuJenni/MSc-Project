...
if finetuned:
    MODEL_PATH = os.path.join(LOG_DIR, '{}_{}_finetune_{}_new_settings2_2/'.format(data.NAME, model.name, net_type))
    LOG_PATH = os.path.join(LOG_DIR, '{}_{}_finetune_{}_eval_new_settings2_2/'.format(data.NAME, model.name, net_type))
else:
