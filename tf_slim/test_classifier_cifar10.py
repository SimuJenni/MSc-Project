...
if finetuned:
    MODEL_PATH = os.path.join(LOG_DIR, '{}_{}_finetune_{}_cond/'.format(data.NAME, model.name, net_type))
    LOG_PATH = os.path.join(LOG_DIR, '{}_{}_finetune_{}_eval_cond/'.format(data.NAME, model.name, net_type))
else:
