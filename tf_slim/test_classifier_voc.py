...
if finetuned:
    ...
    MODEL_PATH = os.path.join(LOG_DIR, '{}_{}_classifier_new_settings3/'.format(data.NAME, model.name))
    LOG_PATH = os.path.join(LOG_DIR, '{}_{}_classifier_new_settings3/'.format(data.NAME, model.name))
