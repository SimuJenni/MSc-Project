...
with sess.as_default():
    with g.as_default():
        ...
        with tf.device('/cpu:0'):
            ...
            imgs_test_p = [preprocess_voc(im, TARGET_SHAPE[0], TARGET_SHAPE[1], aspect_ratio_range=[0.8, 1.3],
                                          area_range=[0.4, 1.0], augment_color=False) for im in imgs_test_p]
        ...
        for c in range(20):
            ...
            # summary_ops.append(op)
            # update_ops.append([update_prec_train, update_rec_train])
