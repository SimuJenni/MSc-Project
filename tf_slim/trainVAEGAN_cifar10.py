...
SAVE_DIR = os.path.join(LOG_DIR, '{}_{}_new_beta0.7/'.format(data.NAME, model.name))
TEST = False
NUM_IMG_SUMMARY = 8
...
with sess.as_default():
    with g.as_default():
        ...
        # Define optimizer
        optimizer = tf.train.AdamOptimizer(learning_rate=learning_rate, beta1=0.7, epsilon=1e-8)
