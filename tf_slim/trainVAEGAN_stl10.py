...
TEST_SET_NAME = 'test'
model = VAEGAN(num_layers=5, batch_size=80, data_size=data.SPLITS_TO_SIZES[TRAIN_SET_NAME], num_epochs=150)
...
with sess.as_default():
    with g.as_default():
        ...
        # Define optimizer
        optimizer = tf.train.AdamOptimizer(learning_rate=learning_rate, beta1=0.5, epsilon=1e-2)
