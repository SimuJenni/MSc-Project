...
with sess.as_default():
    with g.as_default():
        ...
        l2_gen = slim.losses.sum_of_squares(gen_rec, imgs_train, scope=gen_loss_scope, weight=50)  #TODO: weight=100
        l2_mu = slim.losses.sum_of_squares(gen_mu, enc_mu, scope=gen_loss_scope, weight=5) #TODO: weight=10
        l2_sigma = slim.losses.sum_of_squares(gen_logvar, enc_logvar, scope=gen_loss_scope,
                                              weight=5)  #TODO: weight=10
