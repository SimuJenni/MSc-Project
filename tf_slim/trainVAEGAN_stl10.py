...
TEST_SET_NAME = 'test'
model = AEGAN(num_layers=5, batch_size=64, data_size=data.SPLITS_TO_SIZES[TRAIN_SET_NAME], num_epochs=150)
...
with sess.as_default():
    with g.as_default():
        ...
        l2_gen = slim.losses.sum_of_squares(gen_rec, imgs_train, scope=gen_loss_scope, weight=10.0)  #TODO: weight=50
