...
# Real images vs. pseudo-images (full architecture)
...
LR = 0.0002
SAVE_DIR = os.path.join(LOG_DIR, '{}_{}_exp3/'.format(data.NAME, model.name))
TEST = False
NUM_IMG_SUMMARY = 6
...
with sess.as_default():
    with g.as_default():
        ...
        img_rec, gen_rec, disc_out, enc_dist, gen_dist, enc_mu, gen_mu, enc_logvar, gen_logvar = \
            model.net_exp3(imgs_train, toons_train, edges_train)
