...
class ToonNetTrainer:
    ...
    def discriminator_loss(self, disc_out, disc_labels):
        ...
        disc_loss = tf.contrib.losses.mean_squared_error(disc_out, disc_labels, scope=disc_loss_scope, weight=10.0)
    ...
    def generator_loss(self, disc_out, labels_gen, imgs_gen, imgs_train, g_mu, e_mu):
        ...
        gen_disc_loss = tf.contrib.losses.mean_squared_error(disc_out, labels_gen, scope=gen_loss_scope, weight=10.0)
    ...
    def train(self):
        ...
        with self.sess.as_default():
            with self.graph.as_default():
                ...
                # Create the model
                img_rec, img_gen, disc_out, e_mu, g_mu = self.model.net(imgs_train, toons_train)
