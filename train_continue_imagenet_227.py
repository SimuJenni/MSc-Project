...
data = ImageNet()
preprocessor = ImageNetPreprocessor(target_shape=[228, 228, 3])
trainer = ToonNetTrainer(model=model, dataset=data, pre_processor=preprocessor, num_epochs=30, tag='228',
