...
trainer = ToonNetTrainer(model=model, dataset=data, pre_processor=preprocessor, num_epochs=90, tag='NEW_correct3',
                         lr_policy='linear', optimizer='adam', init_lr=0.0004, end_lr=0.00005)
trainer.train()
