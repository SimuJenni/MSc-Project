...
data = ImageNet()
preprocessor = Preprocessor(target_shape=[112, 112, 3], augment_color=True, hsv_color=False, area_range=(0.2, 1.0))
trainer = ToonNetTrainer(model=model, dataset=data, pre_processor=preprocessor, num_epochs=60, tag='nofc13',
                         lr_policy='linear', optimizer='adam', init_lr=0.0004, end_lr=1e-8)
